...
public class ExecuteGetByCoordinates implements Interaction {

    private final String resource;

    public ExecuteGetByCoordinates(String resource) {
    ...
    public static ExecuteGetByCoordinates service(String resource) {
        return Tasks.instrumented(ExecuteGetByCoordinates.class, resource);
    }
}
